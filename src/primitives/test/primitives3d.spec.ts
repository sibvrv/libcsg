...
test('cube (standard size, rounded)', t => {
  ...
  const expPoly5 = {
    vertices: [{pos: {_x: 0.8999999999999998, _y: 0.09999999999999998, _z: 0}},
      {
        pos: {
...
test('cube (custom size, rounded)', t => {
  ...
  const expPoly5 = {
    vertices: [{pos: {_x: 68.5, _y: 0.5, _z: 0}},
      {
        pos: {
...
test('sphere (custom radius , resolution, center)', t => {
  ...
  const expPoly59 = {
    vertices: [{pos: {_x: 9.907600726170914e-17, _y: 7.19829327805997e-17, _z: 4}},
...
test('cylinder (custom double radius, rounded)', t => {
  ...
  const expPoly543 = {
    vertices: [{pos: {_x: -1.1945836920083923e-17, _y: 6.005577771483276e-17, _z: 2}},
...
test('cylinder (custom double diameter, rounded, start, end)', t => {
  ...
  const expPoly543 = {
    vertices: [{pos: {_x: -1.1945836920083923e-17, _y: 6.005577771483276e-17, _z: 11}},
